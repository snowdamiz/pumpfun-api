...
export class APIError extends Error implements APIErrorInterface {
  ...
  constructor(data: APIErrorInterface & { message: string }) {
    super(data.message);
    this.name = 'APIError';
    this.code = data.code;
  ...
  static retryable(data: Omit<APIErrorInterface, 'isRetryable'> & { message: string }): APIError {
...
// Consolidated error classes from infrastructure/error-handling/errors.ts
